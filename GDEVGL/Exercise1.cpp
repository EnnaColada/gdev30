...
float vertices[] =
{
        ...
        //                                                                                  0=noglow, 1=glow  |  0=no rot, 1=ctrclk, 2=clkwise, 3=flap
        //1st flower bud
...
/*129*/-0.50f,-0.560f, 0.00f,       0.8275f, 0.5882f, 0.4784f,      0.000f, 0.000f,         0.00f, 0.00f,
/*130*/ 0.13f,-0.800f, 0.00f,       0.8275f, 0.5882f, 0.4784f,      0.000f, 0.000f,         0.00f, 0.00f,
...
/*133*/-0.50f,-0.350f, 0.00f,       0.7804f, 0.5216f, 0.4275f,      0.000f, 0.000f,         0.00f, 0.00f,
/*134*/ .055f,-0.550f, 0.00f,       0.7804f, 0.5216f, 0.4275f,      0.000f, 0.000f,         0.00f, 0.00f,  
...
/*139*/ 0.13f,-0.800f, 0.00f,       0.7804f, 0.5216f, 0.4275f,      0.000f, 0.000f,         0.00f, 0.00f,
/*140*/ 0.47f,-0.010f, 0.00f,       0.6510f, 0.3843f, 0.3412f,      0.000f, 0.000f,         0.00f, 0.00f,   
/*141*/ 0.47f,-0.530f, 0.00f,       0.7804f, 0.5216f, 0.4275f,      0.000f, 0.000f,         0.00f, 0.00f,
...
/*145*/-0.75f, 0.600f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*146*/-0.78f, 0.630f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*147*/-0.86f, 0.600f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*148*/-.848f, 0.550f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*149*/-0.89f, 0.580f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*150*/-0.92f, 0.560f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*151*/-.925f, 0.520f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*152*/-0.90f, 0.500f, 0.00f,       0.5922f, 0.7294f, 0.9255f,      -0.84f, 0.500f,         0.00f, 3.00f,

    //butterfly back wing
/*153*/-0.80f, 0.500f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*154*/-0.84f, 0.500f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*155*/-0.73f, 0.600f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*156*/-.742f, 0.630f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*157*/-0.83f, 0.600f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*158*/-0.83f, 0.560f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*159*/-0.86f, 0.580f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*160*/-0.90f, 0.570f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*161*/-0.92f, 0.540f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
/*162*/-0.90f, 0.500f, 0.00f,       0.4118f, 0.5294f, 0.8353f,      -0.84f, 0.500f,         0.00f, 3.00f,
